...
public partial class RemovedDailScheduleRelationFromBooking : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropIndex(name: "IX_Bookings_DailyScheduleId", table: "Bookings");

        migrationBuilder.DropColumn(name: "DailyScheduleId", table: "Bookings");
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropIndex(name: "IX_Bookings_CaregiverDailyScheduleId", table: "Bookings");

        migrationBuilder.DropColumn(name: "CaregiverDailyScheduleId", table: "Bookings");
